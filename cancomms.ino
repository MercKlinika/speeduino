...
void sendcanValues(uint16_t offset, uint16_t packetLength, byte cmd, byte portType)
{
  ...
  fullStatus[75] = (byte)(currentStatus.LPGTemp + CALIBRATION_TEMPERATURE_OFFSET); //lpg temp
  fullStatus[76] = currentStatus.lpgTempCorrection; //Lpg temperature Correction (%)
  fullStatus[77] = currentStatus.lpgp; //Lpg Pressure
  fullStatus[78] = currentStatus.lpgpCorrection;
