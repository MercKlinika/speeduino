...
void createLog(uint8_t *logBuffer)
{
    ...
    logBuffer[113] = (byte)(currentStatus.LPGTemp + CALIBRATION_TEMPERATURE_OFFSET);
    logBuffer[114] = currentStatus.lpgTempCorrection; 
    logBuffer[115] = currentStatus.lpgp; 
    logBuffer[116] = currentStatus.lpgpCorrection;
}
